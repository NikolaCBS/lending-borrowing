use crate::{self as lending_borrowing};
...
construct_runtime! {
        ...
        UncheckedExtrinsic = UncheckedExtrinsic,
    {
        ...
        LendingBorrowing: lending_borrowing::{Pallet, Call, Storage, Event<T>},
    }
}
    ...
    fn default() -> Self {
        Self {
            ...
            endowed_accounts: vec![
                ...
                (CHARLIE, XOR, balance!(1500)),
                (DAVE, XOR, balance!(1000)),
            ],
        }
    }
}
...
pub fn run_to_block(n: u64) {
    while System::block_number() < n {
        ...
        LendingBorrowing::on_initialize(System::block_number());
    }
}
